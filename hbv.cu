...
__global__ void hbv_dynamic( float *q, float *etr, float *qin, float *qlz, float *qq, float *qi, float *qcf, float *sp, float *inet, float *qdr, float *pp, float *etp, float *sm, float *fc, float *vlz, float *vuz, float *cflux, float *icf, float *beta, float *lp, float *perc, float *uzl, float *klz, float *ki, float *kq)
{
